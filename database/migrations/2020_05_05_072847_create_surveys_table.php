...
class CreateSurveysTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('surveys', function (Blueprint $table) {
            ...
            $table->enum('verificator_1', ['Pending', 'Complete', 'Reject']);
            $table->enum('verificator_2', ['Pending', 'Complete', 'Reject']);
            $table->enum('manager_1', ['Pending', 'Complete', 'Reject']);
            $table->enum('manager_2', ['Pending', 'Complete', 'Reject']);
            $table->enum('deployment_1', ['Pending', 'Complete', 'Reject']);
            $table->enum('deployment_2', ['Pending', 'Complete', 'Reject']);
